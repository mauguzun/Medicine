...
namespace Medicine.Web.UseCases.Auth.Dto
{
    ...
    public record UserSettingsDto(int UserId, string Name, string Email, string PhoneNumber, SystemRole Role, Language Language, Sex Sex, DateOnly? Birthday, Entities.Enums.TimeZone TimeZone)
    {
